...
const compressImageClient = (file: File, maxWidth = 1200, maxQuality = 0.7): Promise<File> => {
...
export default function ManualBroadcastPage() {
  ...
  const handleSend = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (mediaType === "image" && mediaSource === "upload" && selectedFile) {
        fileToUpload = await compressImageClient(selectedFile);
      }
